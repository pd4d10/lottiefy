...
CCRenderer.prototype.createShape = function (data) {
    return new CCShapeElement(data,this.globalData,this);
};

CCRenderer.prototype.createText = function (data) {
    return new CCTextElement(data,this.globalData,this);
...
CCRenderer.prototype.destroy = function () {
...
CCRenderer.prototype.updateContainerSize = function () {
};
...
CCRenderer.prototype.appendElementInPos = function(element, pos){
...
CCRenderer.prototype.hide = function(){
    this.layerElement.style.display = 'none';
};

CCRenderer.prototype.show = function(){
